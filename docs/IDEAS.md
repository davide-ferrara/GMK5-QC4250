...
Golf Mk5 / QC4250: velocità, quattro sportelli, freno di stazionamento, luci esterne e
...
- Aggiungere alla pagina Info una diagnostica compatta: velocità CAN ricevuta,
  stato dei quattro sportelli, cofano, luci e freno di stazionamento.
- Mostrare nel render un indicatore discreto del freno di stazionamento inserito;
  non trasformarlo in un avviso di sicurezza o in un comando.
...
- Definire una tabella di test manuale per ogni variante visiva: tutte le
  porte, cofano, luci on/off, freno inserito/rilasciato e passaggio fermo/in movimento.
